...
# ----------------------
BIRTH_MAPS = {
    "Benedict XVI": {"_pope_id": 1, "place_of_birth": "Marktl, Germany"},
    "John Paul II": {"_pope_id": 2, "place_of_birth": "Wadowice, Poland"},
    "Paul VI": {"_pope_id": 3, "place_of_birth": "Concesio, Italy"},
    "Francis": {"_pope_id": 4, "place_of_birth": "Buenos Aires, Argentina"},
    "Leo XIV": {
        "_pope_id": 5,
        ...
        with connection:
            ...
            for name, pope_info in BIRTH_MAPS.items():
                ...
                if cursor.rowcount == 0:
                    print(
                        f"Warning: No match found for {name} with ID {pope_info['_pope_id']}. No update made."
                    )
                else:
